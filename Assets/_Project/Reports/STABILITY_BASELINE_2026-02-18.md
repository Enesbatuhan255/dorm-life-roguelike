...
## Validation snapshot
- EditMode (`DormLifeRoguelike.Tests.EditMode`): Passed 77/77
- PlayMode (`DormLifeRoguelike.Tests.PlayMode`): Passed 4/4
- Choice coverage report: 0 violations
- Event chain graph report: all exported targets resolve (`targetExists=1`)

## Follow-up note
- PlayMode context-tag coverage test was hardened to avoid weighted-random flakiness.
